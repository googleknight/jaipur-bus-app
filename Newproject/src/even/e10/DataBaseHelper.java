...
public class DataBaseHelper extends SQLiteOpenHelper {
	...
	private static String DB_PATH = "/data/data/even.e10/databases/";

	private static String DB_NAME = "Businfo";
	...
	public List<String> getAllLabelsorderby(String TABLE_NAME,String COLUMN_NAME) {
		List<String> list = new ArrayList<String>();
